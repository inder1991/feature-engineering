...
// the flat /connectors path was removed in the two-tier restructure.
const API_PATHS = ['/uploads', '/search', '/sources', '/columns', '/join-path', '/features', '/graph', '/health', '/integrations', '/syncs']
