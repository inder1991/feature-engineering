def calculate_cross_border_value_ratio_90d(
    ...
    # §8 rule 4's ÷0 half — the declared zero_denominator is `null`. The test is on the
    ...
    staged = staged.withColumn('cross_border_value_ratio_90d', numerator_value / divisor)
