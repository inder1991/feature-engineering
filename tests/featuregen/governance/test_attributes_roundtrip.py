...
def test_governance_attributes_round_trip_through_feature_versions(db):
    attrs = GovernanceAttributes(
        feature_version_id="fv_rt",
        feature_id="feat_rt",
        produced_by_run="run_rt",
