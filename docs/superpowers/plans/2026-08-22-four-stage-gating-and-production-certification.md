...
▲ **2026-08-24 pointer (Task P1, cross-catalog serving):** allocations **1120–1139** live in the two cross-catalog plan docs, not in this table — `2026-08-23-cross-catalog-program-rev5.md` (1120–1121, both since applied live) together with its remediation companion's 1122–1129 block, and `2026-08-24-cross-catalog-serving-first-card.md`, whose §T0-assigned migration mapping is the authoritative 1130–1139 table (it also records 1117 staying reserved-unused).
