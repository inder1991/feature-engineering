...
> **IMPLEMENTATION begins now.** The Stage-2 serving program is implemented by `2026-08-24-cross-catalog-serving-first-card.md` (Rev 13), which starts immediately by owner ruling — ahead of criteria (4)–(5). Stage-1 rigor applies; nothing merges/deploys/flips without explicit user go.
