# PHASE 06 IS AUTHORITATIVE for GateTaskSpec / SignalResult — they live in featuregen.contracts.envelopes.
...
from featuregen.contracts.envelopes import GateTaskSpec, SignalResult
