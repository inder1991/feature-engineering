...
# canonical frozen/slots dataclass in featuregen.contracts.envelopes; this module re-exports that
# SAME class object so `featuregen.contracts.documents.NewDocument is featuregen.contracts.envelopes.NewDocument`
