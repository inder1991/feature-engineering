...
from featuregen.contracts import ConcurrencyError, DbConn, EventEnvelope, NewEvent
from featuregen.events.registry import event_registry
from featuregen.events.serde import identity_to_jsonb, provenance_to_jsonb, row_to_event
from featuregen.privacy.classification import assert_no_inline_pii
...
_GLOBAL_SEQ_LOCK_KEY = 4_201_873_355_201_001  # arbitrary fixed key, unique to featuregen seq alloc
