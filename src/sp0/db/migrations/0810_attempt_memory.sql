...
CREATE TABLE IF NOT EXISTS attempt_memory (
...
CREATE INDEX IF NOT EXISTS attempt_memory_feature_idx ON attempt_memory (feature_id) WHERE feature_id IS NOT NULL;
